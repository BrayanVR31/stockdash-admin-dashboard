export enum VALID_MSG {
  REQUIRED_FIELD = "The {{field}} input is required.",
  REQUIRED_ARRAY = "The {{field}} must be have at least 1 item in the array",
  INVALID_STRING = "The {{field}} input is not a valid string.",
  ...
  EMPTY_STRING = "The {{field}} input must be at least 1 character long.",
}
